...
//********** Adding Production, Dectruction, and DZEff terms for Laminar Model ***********//
template<class BasicTurbulenceModel>
Foam::tmp<Foam::volScalarField>
Foam::laminarModel<BasicTurbulenceModel>::Production() const
{
    ...
    (
        ...
        (
            IOobject
            (
                IOobject::groupName("Production", this->U_.group()),
            ...
            this->mesh_,
            dimensionedScalar("Production", dimDynamicViscosity, 0.0)
        )
    );
}
...
template<class BasicTurbulenceModel>
Foam::tmp<Foam::volScalarField>
Foam::laminarModel<BasicTurbulenceModel>::Destruction() const
{
    return tmp<volScalarField>
    (
        new volScalarField
        (
            IOobject
            (
                IOobject::groupName("Destruction", this->U_.group()),
                this->runTime_.timeName(),
                this->mesh_,
                IOobject::NO_READ,
                IOobject::NO_WRITE,
            ...
            this->mesh_,
            dimensionedScalar("Destruction", dimDynamicViscosity/dimArea, 0.0)
        )
    );
}
...
template<class BasicTurbulenceModel>
Foam::tmp<Foam::volScalarField>
Foam::laminarModel<BasicTurbulenceModel>::DZEff() const
{
    return tmp<volScalarField>
    (
        new volScalarField
        (
            IOobject::groupName("DZEff", this->U_.group()), this->rho_*this->nu()
        )
    );
}
/*
...
Foam::laminarModel<BasicTurbulenceModel>::Production() const
{
    ...
    (
        IOobject::groupName("Production", this->alphaRhoPhi_.group()),
        this->mesh_,
        dimensionedScalar("Production", dimDynamicViscosity, 0.0)
    );
}
...
Foam::laminarModel<BasicTurbulenceModel>::Destruction() const
{
    return tmp<volScalarField>::New
    (
        IOobject::groupName("Destruction", this->alphaRhoPhi_.group()),
        this->mesh_,
        dimensionedScalar("Destruction", dimDynamicViscosity/dimArea, 0.0)
    );
}
...
Foam::laminarModel<BasicTurbulenceModel>::DZEff() const
{
    ...
    (
        IOobject::groupName("DZEff", this->alphaRhoPhi_.group()),
        this->rho_*this->nu()
    );
}
*/
